 ...
 */
public class IniEditorAdapter implements IniEditorTarget {
    ...
    public static void main(String[] args) throws IOException {
        String a = new IniEditorAdapter().getValue("myInterface","myColorR");
        System.out.println(a);
        new IniEditorAdapter().setValue("myInterface","myColorR","100");
    }
